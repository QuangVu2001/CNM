...
Original file is located at
    https://colab.research.google.com/drive/1DeBCD2gEoUWjeCDLNOWeMC67crENXnpU
...
# Import all of them 
sales=pd.read_csv("/content/drive/MyDrive/NCKH/sales_train.csv")

# settings
import warnings
warnings.filterwarnings("ignore")

item_cat=pd.read_csv("/content/drive/MyDrive/NCKH/item_categories.csv")
item=pd.read_csv("/content/drive/MyDrive/NCKH/items.csv")
sub=pd.read_csv("/content/drive/MyDrive/NCKH/sample_submission.csv")
shops=pd.read_csv("/content/drive/MyDrive/NCKH/shops.csv")
test=pd.read_csv("/content/drive/MyDrive/NCKH/test.csv")
